...
class TestVPCOffering(cloudstackTestCase):
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_02_create_vpc_offering_with_selected_service_offering(self):
    ...
    def test_03_deploy_vms_in_vpc_nw(self):
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_04_vpc_off_without_lb(self):
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_05_vpc_off_without_static_nat(self):
        ...
        self.services["vpc_offering"][
            "supportedservices"] = 'Vpn,Dhcp,Dns,SourceNat,Lb,UserData,PortForwarding,NetworkACL'
        self.services["network_offering"][
            "supportedservices"] = 'Vpn,Dhcp,Dns,SourceNat,Lb,UserData,PortForwarding,NetworkACL'
        self.services["network_offering"]["serviceProviderList"] = {
            "Vpn": 'VpcVirtualRouter',
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_06_vpc_off_without_pf(self):
        ...
        self.services["network_offering"][
            "supportedservices"] = 'Vpn,Dhcp,Dns,SourceNat,Lb,UserData,StaticNat,NetworkACL'
        self.services["network_offering"]["serviceProviderList"] = {
            "Vpn": 'VpcVirtualRouter',
            "Dhcp": 'VpcVirtualRouter',
            "Dns": 'VpcVirtualRouter',
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_07_vpc_off_invalid_services(self):
        ...
        self.services["vpc_offering"][
            "supportedservices"] = 'Dhcp,Dns,PortForwarding,Firewall,Vpn,SourceNat,Lb,UserData,StaticNat'
    ...
    @attr(tags=["advanced", "intervlan"], required_hardware="false")
    def test_08_update_vpc_off(self):
    ...
    def test_10_create_redundant_vpc_offering(self):
